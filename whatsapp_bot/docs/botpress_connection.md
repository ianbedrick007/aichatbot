...
You can check out [this video from Botpress](https://www.youtube.com/watch?v=LQd1iGJLj58&) for a video walkthrough of
the following steps. If you have never used WhatsApp for business, please refer
to [this page]((https://developers.facebook.com/docs/whatsapp/cloud-api/get-started)). This tutorial will use a WhatsApp
test number that will be automatically created for you. I believe, you cannot have two Test numbers under one Meta
business account.
...
15. Now go back to API Setup and select your test phone number (or add if it's your first time). This should be your own
    number that you have access to.
